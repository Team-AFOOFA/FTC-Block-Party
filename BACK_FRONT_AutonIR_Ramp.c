...
task main()
{
    ...
    motor[LeftDrive] = -30;
		...
		while(LeftIRVal != 6) //move back until robot is perpendicular to IR beacon
		{
			motor[LeftDrive] = -60; //both used to be -70, but were reduced
			motor[RightDrive] = -60; //to decrease inertia while avoiding alliance robot
			wait10Msec(1);
